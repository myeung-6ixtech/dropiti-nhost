...
- [api-doc-v1.md](./api-doc-v1.md) for the full HTTP API reference **(document v2.0 — May 2026)** — routing, envelopes, route tables — consumed by **`dropiti-admin-console`** via `NEXT_PUBLIC_FUNCTIONS_URL` and the Next.js BFF.
